...
# 2021.08.11
# Fine-tuning version.
# using pretrained model (swav_800ep_pretrain)

#run : python -m torch.distributed.launch --nproc_per_node=2 main_swav_TL_ver.py
...
#########################
##here
parser.add_argument("--data_path", type=str, default="/home/sh/Desktop/env_swav/liver_dataset/2fold_dataset/fold2/train/",
...
##here
parser.add_argument("--dump_path", type=str, default="/home/sh/Desktop/env_swav/liver_dataset/2fold_result/b",
...
def main():
    ...
    #         if name.find("pro") == 0 or name.find("layer4") == 0 or name.find("layer3.5") == 0:
